# Servidor HTTP local — Freedom4 (127.0.0.1, sem Node/Cursor)
...
try {
  ...
  Write-Host ""
  Write-Host "Tente executar como Administrador OU use Iniciar-FREEDOM-direto.bat"
  Read-Host "Pressione Enter para sair"
  exit 1
}

Write-Host "Freedom4 rodando em $Prefix"
Write-Host "Pasta: $Root"
Write-Host "Feche esta janela para encerrar o servidor."
Write-Host ""

if (-not $env:FREEDOM_NO_BROWSER) {
